...
userSchema.methods.generateAuthToken = async function () {  // methods can be accessed by instances
    const user = this
...
userSchema.statics.findByCredentials = async (email, password) => {  //statics can be accessed by models
